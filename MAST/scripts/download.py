...
from MAST.config import PROJECT_DIR, LOCAL_DATA_DIR, BOP_DS_DIR
...
def main():
    parser = argparse.ArgumentParser('MAST download utility')
    ...
    if args.all_bop20_models:
        from MAST.bop_config import (PBR_DETECTORS, PBR_COARSE, PBR_REFINER,
    ...
    if args.all_bop20_results:
        from MAST.bop_config import (PBR_INFERENCE_ID, SYNT_REAL_INFERENCE_ID, SYNT_REAL_ICP_INFERENCE_ID,
