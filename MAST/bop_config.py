...
PBR_COARSE = dict(
    ...
    # lmo='bop-lmo-pbr-coarse-transnoise-zxyavg-decoupled-bindelta-icg-selft/01',  # LineMod weights id
    tless='coarse-bop-tless-pbr--506801',
    tudl='coarse-bop-tudl-pbr--373484',
    # ycbv='bop-ycbv-pbr-coarse-transnoise-zxyavg-decoupled-bindelta-icg',
)
...
PBR_REFINER = dict(
    ...
    lmo='bop-lmo-pbr-refiner-transnoise-zxyavg-decoupled-bindelta',  # LineMod weights id
