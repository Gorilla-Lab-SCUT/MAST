...
class LMO_bop_Dataset(Dataset):
    def __init__(self, ds_dir='local_data/bop_datasets/lmo', split='test_bop', load_depth=False) -> None:
        super().__init__()
...
if __name__ == "__main__":
    a = LMO_bop_Dataset('local_data/bop_datasets/lmo','test_bop')
    dl = a.dataloader()
