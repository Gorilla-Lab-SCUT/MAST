...
class HB_Dataset(Dataset):
    def __init__(self, ds_dir='local_data/bop_datasets/hb', split='val_02', load_depth=False) -> None:
        super().__init__()
        ...
        self.hb2lmo_id_map = {'000002': '000002', '000007': '000008', '000021': '000015'}
    ...
    def __getitem__(self, frame_id):
        ...
        Trans = {}
        for obj in objects:
            Trans[self.hb2lmo_id_map[obj['label'].strip('obj_')]] = obj['TWO']
...
if __name__ == "__main__":
    a = HB_Dataset('local_data/bop_datasets/hb','val_02')
    dl = a.dataloader()
